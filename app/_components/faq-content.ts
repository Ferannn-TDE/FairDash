...
// prose has no drift-guard — if a constant changes, change it here too. Sharing
// this file is what keeps it ONE second copy rather than two.
// ---------------------------------------------------------------------------
...
export const FAQ_CATEGORIES: FAQCategory[] = [
  { id: 'customers', label: 'Customers', items: [
    ...
    { q: 'Can I cancel an order?', a: "Yes, for free before the vendor accepts it. Once they've accepted, a $5 cancellation fee applies." },
  ]},
  ...
  { id: 'runners', label: 'Runners', items: [
    ...
    { q: 'How is a home delivery confirmed?', a: 'By GPS. You confirm the drop-off within 100 metres of the delivery address.' },
  ]},
