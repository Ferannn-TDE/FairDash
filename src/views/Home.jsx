        ...
        <div className="p-6 md:p-4 sm:p-3">
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:flex bg-bg-card px-4 py-2.5 rounded-full text-sm font-semibold text-white border border-white/10 items-center gap-2 max-w-[40vw] lg:max-w-[22rem]">
