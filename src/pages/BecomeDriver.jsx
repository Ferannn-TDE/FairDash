...
const DRIVER_TERMS = `FAIR DASH DRIVER AGREEMENT

Last Updated: January 1, 2026

This Driver Agreement ("Agreement") is between Fair Dash LLC ("FairDash") and you ("Driver"). By completing this application, you agree to the terms below in full.

1. DRIVER ELIGIBILITY
To drive for FairDash you must: (a) be at least 18 years of age; (b) hold a valid U.S. driver's license; (c) own or have authorized access to a vehicle in safe, roadworthy condition; (d) consent to a background check and motor vehicle record review; and (e) carry valid auto insurance meeting state minimums. FairDash reserves the right to reject or terminate any driver application based on background check results.

2. INDEPENDENT CONTRACTOR STATUS
You acknowledge that you are an independent contractor, not an employee of FairDash. You are responsible for all taxes, insurance, and expenses related to your work. FairDash does not provide workers' compensation, health insurance, or other employee benefits. You may work for other platforms and set your own schedule, subject to fair event availability.

3. PAY & EARNINGS
Drivers earn a base delivery fee per completed order plus 100% of customer tips. The base fee varies by delivery distance, typically $3.00–$6.00 per order. Pay is deposited weekly via ACH direct deposit. FairDash may offer bonuses during peak periods at its discretion.

4. VEHICLE REQUIREMENTS
Your vehicle must: (a) pass a visual inspection if requested by FairDash; (b) be clean and free of strong odors that could affect food; (c) have functional heat and air conditioning for appropriate food temperature maintenance; and (d) display no offensive or inappropriate markings. Bicycles and electric scooters may be approved for designated zones.
        ...
        {step === 4 && (
          <div className="bg-bg-card border border-white/10 rounded-2xl p-10 text-center animate-fadeIn">
            ...
            <p className="text-text-gray text-base mb-2">
              Thanks for applying to drive for FairDash,{" "}
