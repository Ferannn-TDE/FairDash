        ...
        <div className="bg-bg-card border border-white/10 rounded-2xl p-6 mb-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              {isEditing ? (
                <input
                  ...
                  className="w-full bg-bg-dark border border-white/10 rounded-xl px-4 py-3 text-white text-sm outline-none focus:border-neon-pink transition-colors placeholder:text-text-gray/50"
                  placeholder="First name"
                />
              ) : (
                <div className="flex items-center gap-2.5 px-4 py-3 bg-white/[0.03] border border-white/5 rounded-xl text-sm text-white">
            ...
            <div>
              ...
              <div className="flex items-center gap-2.5 px-4 py-3 bg-white/[0.03] border border-white/5 rounded-xl text-sm text-text-gray">
        ...
        <div className="bg-bg-card border border-white/10 rounded-2xl p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { key: "newVendors", label: "New Vendors", desc: "Alerts when new vendors join FairDash" },
            ].map(({ key, label, desc }) => (
