...
const VENDOR_TERMS = `FAIR DASH VENDOR AGREEMENT

Last Updated: January 1, 2026

This Vendor Agreement ("Agreement") is entered into between Fair Dash LLC ("FairDash," "we," or "us") and the vendor ("Vendor," "you") applying to participate on the FairDash platform. By completing this application and clicking "I Agree," you accept the following terms and conditions in full.

1. VENDOR ELIGIBILITY
To become a FairDash vendor, you must: (a) be a legally registered business or sole proprietor operating under applicable local and state law; (b) hold all required food handler permits, health department certifications, and business licenses for your jurisdiction; (c) maintain valid general liability insurance of at least $1,000,000 per occurrence; and (d) agree to operate within the designated FairDash service area during scheduled fair events.

2. PLATFORM FEES & COMMISSIONS
FairDash charges a commission of 12% on each completed order processed through the platform. This commission covers payment processing, platform maintenance, customer support, and driver dispatch services. Vendors will receive payment via ACH direct deposit within 3–5 business days after each event settlement period. FairDash reserves the right to adjust commission rates with 30 days' written notice.

3. MENU & PRICING
Vendors are responsible for maintaining accurate, up-to-date menu listings including item names, descriptions, allergen information, and pricing. Prices listed on FairDash must match or be lower than prices charged at your on-site booth. FairDash may remove or flag menu items that violate health guidelines, contain misleading information, or are consistently reported as unavailable.

4. ORDER FULFILLMENT & QUALITY
You agree to: (a) prepare orders promptly and to the same quality standard as your on-site menu items; (b) notify FairDash immediately if an item becomes unavailable so it may be temporarily removed from the platform; (c) package orders securely for delivery or curbside pickup; and (d) maintain a minimum order fulfillment rate of 95% per event. Repeated failures to meet this standard may result in account suspension.

5. FOOD SAFETY & COMPLIANCE
All food prepared and sold through FairDash must comply with applicable food safety regulations, including proper temperature control, allergen labeling, and handling procedures. FairDash reserves the right to conduct unannounced quality checks and may suspend vendor access pending investigation of any food safety complaint. Vendors indemnify FairDash against any claims arising from foodborne illness or improper food handling.

6. CUSTOMER REVIEWS & RATINGS
FairDash operates a public rating and review system. Vendors with an average rating below 3.5 stars over a 30-day rolling period may receive a performance notice. Continued low ratings may result in reduced platform visibility or account suspension. Vendors may not incentivize, solicit, or manipulate reviews in any way.

7. INTELLECTUAL PROPERTY
By submitting photos, menu descriptions, logos, and other materials to FairDash, you grant FairDash a non-exclusive, royalty-free, worldwide license to use, reproduce, and display such materials in connection with the FairDash platform, marketing, and promotional activities. You retain ownership of your content and warrant that you have the right to grant this license.

8. TERMINATION
Either party may terminate this Agreement with 14 days' written notice. FairDash may terminate immediately, without notice, for violations of this Agreement, fraudulent activity, repeated food safety complaints, or conduct that harms the FairDash brand or customers. Upon termination, any outstanding payments will be settled within 14 business days.

9. LIMITATION OF LIABILITY
FairDash's liability to you for any claim arising out of this Agreement shall not exceed the total commissions paid by you to FairDash in the 30 days preceding the claim. FairDash is not liable for loss of revenue, loss of data, or any indirect, incidental, or consequential damages.
...
11. MODIFICATIONS
FairDash reserves the right to update this Agreement at any time. You will be notified of material changes via email or in-platform notification. Continued use of the FairDash platform after notice of changes constitutes acceptance of the revised terms.
      ...
      <div className="max-w-[700px] mx-auto px-[6%] md:px-5 py-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-text-gray text-base">
            Join the FairDash marketplace and reach thousands of fair-goers.
          </p>
        </div>
          ...
          <div className="bg-bg-card border border-white/10 rounded-2xl p-7 animate-fadeIn">
            ...
            <label className="flex items-start gap-3 cursor-pointer group">
              ...
              <span className="text-sm text-text-gray leading-relaxed">
                ...
                outlined above. I understand that FairDash charges a 12% commission on all orders.
              </span>
            </label>
          </div>
        )}
        ...
        {step === 4 && (
          <div className="bg-bg-card border border-white/10 rounded-2xl p-10 text-center animate-fadeIn">
            ...
            <p className="text-text-gray text-base mb-2">
              Thanks for applying to become a FairDash vendor, <strong className="text-white">{business.name || "your business"}</strong>.
            </p>
