...
const SUITES: Suite[] = [
  ...
  // The money-moving accept timer must never be armed on a fair that is not open.
  { group: 'money',       name: 'accept-timer-arming', file: 'scripts/accept-timer-arming-guard.ts' },
  ...
  { group: 'correctness', name: 'rtdb-bound',             file: 'scripts/rtdb-bound-guard.ts' },
  { group: 'boundary',    name: 'draft-fair-exclusion', file: 'scripts/draft-fair-exclusion-guard.ts' },
